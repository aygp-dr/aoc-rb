...
#+PROPERTY: header-args:sh :tangle solve.sh :shebang "#!/bin/sh"
#+PROPERTY: header-args:ruby :tangle solution_literate.rb :shebang "#!/usr/bin/env ruby"
#+PROPERTY: header-args:python :tangle solution.py :shebang "#!/usr/bin/env python3"
